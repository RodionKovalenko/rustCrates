...
datatime = datetime.datetime.today()
datestr = str(datatime.day) + '.' + str(datatime.month) + '.' + str(datatime.year) + '-' + str(datatime.hour) + '-' + str(datatime.minute)
save_plot_dir = 'predictions/prediction-bidirectional-conv-normalized/' + str(datestr)
...
for currency in currencies:
    if currency == 'ETH-EUR':    
        ...
        saved_model_path = 'saved_models/lstm-trained-bidirectional-normalized/' + currency       
