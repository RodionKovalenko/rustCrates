use crate::neural_networks::{
    ...
    utils::{dtype::{C, Real, real_from_f64}, matrix::{add_matrix_3d, scale_matrix_3d_by_scalar}},
};
...
impl FeedForwardLayer {
    ...
    pub fn new(rows: usize, cols: usize, learning_rate: f64) -> Self {
        ...
        let _dense_layer_2: Layer = Layer::new(cols, rows, &learning_rate, &ActivationType::LEAKYRELU, LayerType::DenseLayer);
