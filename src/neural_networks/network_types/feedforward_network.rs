...
use crate::neural_networks::network_types::feedforward_network_generic::{
...
// pub fn forward(feed_net: &mut FeedforwardNetwork<f64>, _data_input: &Data<f64, f64>) {
...
// pub fn backward(_feed_net: &mut FeedforwardNetwork<f64>, _data_input: &Data<f64, f64>) {
...
// pub fn calculate_total_loss(
//     data_structs: &mut Vec<Data<f64, f64>>,
...
//             total_loss +=
//                 (feed_net.layers[feed_net.layers.len() - 1].errors[ind.clone()][e]).powf(2.0);
//         }
//     }
...
//     let input_dimensions = vec![
//         number_rows_in_set as usize,
...
//     println!(
//         "input dimenstions: {}, {}, {}",
//         input_dimensions[0], input_dimensions[1], input_dimensions[2]
//     );

//     let feedforward_network: FeedforwardNetwork<f64> = create(
...
//         let layer_type = layer::get_layer_type(&i, &number_of_hidden_layers);
...
//         saved_network.layers[i.clone()].input_data =
//             create_generic_3d(number_rows_in_set.clone(), number_of_data_sets.clone());
//     }
