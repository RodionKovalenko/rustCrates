...
pub fn simulate_click_events() {
    ...
    let search_items = [
        ...
        "it is possible to get access to browser api?",
        "be healthy",
        "are fruits healthy",
        "what is our future?",
        "verschwörungstheorie existiert?",
        "recurrent neural network are still good?",
        ...
        "who am I?",
        "is it good to be faithful to your partner?",
